 ...
 * [GuidedDecisionGraph]{@link
 * https://github.com/jrleszcz/grammar-graph/blob/master/api.md#GuidedDecisionGraph}
...
var GuidedMusicMachine = function (guide, key, initialScaleDegrees) {
   ...
   * @param {string} pitchChoice - a pitch string in the current set of next choices
  ...
  this.choose = function (pitchChoice) {
    ...
    if (construction.length === 0) {
      ...
      if (thisGuide.choices().indexOf(Pitch(pitchChoice).sciPitch()) === -1) {
